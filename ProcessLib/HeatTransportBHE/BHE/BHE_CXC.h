    ...
    public:
        ...
        */
        BHE_CXC(const std::string name             /* name of the BHE */,
                ...
                : BHEAbstract(BHE_TYPE::TYPE_CXC, name, borehole_geometry, pipe_geometry, std::move(bhe_curves), bound_type, if_use_ext_Ra_Rb, user_defined_R_vals, if_flowrate_curve)
        {
