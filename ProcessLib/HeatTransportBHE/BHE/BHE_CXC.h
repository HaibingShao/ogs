    ...
    public:
        ...
        */
        BHE_CXC(const std::string name             /* name of the BHE */,
                ...
                Pipe_Geometry pipe_geometry = { 0.024 /* inner radius of the pipline */,
                ...
                : BHEAbstract(BHE_TYPE::TYPE_CXC, name, borehole_geometry, pipe_geometry, refrigerant_param, std::move(bhe_curves), bound_type, if_use_ext_Ra_Rb, user_defined_R_vals, if_flowrate_curve)
        {
